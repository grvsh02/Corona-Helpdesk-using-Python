...
"}")
        ...
        self.label_title.setGeometry(QRect(0, 60, 661, 75))
        font = QFont()
...
"QProgressBar::chunk{\n"
"	border-radius: 10px;\n"
"	background-color: qlineargradient(spread:pad, x1:0, y1:0.597, x2:1, y2:0.614, stop:0 rgba(170, 255, 255, 255), stop:1 rgba(85, 170, 255, 255));\n"
"}")
    ...
    def retranslateUi(self, SplashScreen):
        ...
        self.label_title.setText(QCoreApplication.translate("SplashScreen", u"<strong>Covid</strong> Info desk", None))
        ...
        self.label_credits.setText(QCoreApplication.translate("SplashScreen", u"<strong>Created</strong>: Gaurav Sharma", None))
    # retranslateUi
